...
@app.post("/home/get_inference_page/save_and_execute", status_code=status.HTTP_200_OK)
async def save_and_execute(req: InferenceRequest):
    # write codes
    ...
    req.image = req.image[req.image.index(',') + 1:]
